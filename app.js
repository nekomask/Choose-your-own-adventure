...
console.log("You are a stray dog just trying to ruff it in the mean streets. It's a dog-eat-dog world, no bones about it.")
...
console.log("As you glance around, you realize this is an alleyway and you slept on a cardboard box. You've woken up in worse places though.")
...
console.log("As you leave the Butcher Shop, a stray cat approaches. His souless eyes send a chill down your spine.")
console.log("You've been around the block enough times to know that all cats are agents of chaos. But they either mind themselves or are full blown psychotic.")
...
function butcherEncounter(){
    ...
    if(butcherDecision == "B" || butcherDecision == "b"){
    ...
    }else if(butcherDecision == "S" || butcherDecision == "s"){
        console.log("You sit and stare at the Butcher while wagging your tail patiently.")
        console.log("The Butcher smiles and reaches into his apron, offering you a succulent goose liver. It's actually a delicacy in France.")
        console.log("The Butcher is now your friend.")
        console.log("'Tasty Goose Liver' added to inventory.")
        friends.push("The Butcher")
        playerItems.push("Tasty Goose Liver")

    }else{
        console.log("The drool begins to slide down your chin as you gaze into the abyss. As you reflect upon your shortcomings and potentially erroneous choices that led up to this moment-- a feeling of dread creeps over you. The abyss begins to stare back.")
        console.log("Maybe you should pick one of the available choices.")
        butcherEncounter();
    }
    }
    ...
    function catEncounter(){
        ...
        if(catDecision == "B" || catDecision == "b"){
        ...
        }else if(catDecision == "I" || catDecision == "i"){
